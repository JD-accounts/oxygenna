...
(function() {
    ...
    DefaultToolbarController.$inject = ["$scope", "$mdMedia", "$translate", "$state", "$element", "$filter", "$mdUtil", "$mdSidenav", "$mdToast", "$timeout", "triBreadcrumbsService", "triSettings", "triLayout"];
})();
(function() {
    'use strict';
